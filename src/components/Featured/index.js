...
const Featured = () => {
  ...
  return (
    <section id="projects">
      <NumberedHeading ref={revealTitle}>Side Projects</NumberedHeading>
            ...
            return (
              <StyledProject key={title} ref={(el) => (revealProjects.current[i] = el)}>
                <div className="project-content">
                  ...
                  {/* deepcode ignore ReactArrayLengthLogicalAnd: <please specify a reason of ignoring this> */}
                  {techs.length && (
                ...
                <StyledProjectImgWrapper>
                  <a href={external || github || '#'} rel="noreferrer" target="_blank">
