...
const Nav = ({ isHome }) => {
  ...
  const handleClickResume = () => {
    ...
    //   });
    // }
    window.open('https://thammami01.github.io/CV', '_blank');
  };
          ...
          {isMounted && (
            <CSSTransition classNames={fadeClass} timeout={timeout}>
              <div className="logo" tabIndex="-1">
                {isHome ? (
                  <a aria-label="home" style={{ cursor: 'default' }}>
